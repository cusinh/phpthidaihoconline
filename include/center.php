...
<div class="content">
 ...
 $taikhoan=$_SESSION["taikhoan"];
	$lenh=mysqli_query($conn,"SELECT madethi FROM bailam WHERE taikhoan='$taikhoan' GROUP BY id DESC LIMIT 1");
	...
	//$lenh1=mysqli_query($conn,"select cautl from tra where madethi='$madethi' and taikhoan='$taikhoan'");
	$cau=0;
 ...
 ?>
	<table width="220">
		...
		<tr class="my_style">
          <td width="50">
		 	<?php 
           		$lenh3="select cautl from tra_d_an where taikhoan='$taikhoan' and macauhoi='$row[macauhoi]' ";
                $kqua1=mysqli_query($conn,$lenh3);
...
$row1=mysqli_fetch_array($lenh);
$madethi=$row1['madethi'];
$lenh2=mysqli_query($conn,"select noidung,hinhanh from cauhoi where  madethi='$madethi'");
